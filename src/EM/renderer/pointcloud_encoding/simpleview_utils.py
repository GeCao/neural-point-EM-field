...
def points2depth(points, image_height, image_width, size_x: int = 4, size_y: int = 4):
    """
    ...
    # pdb.set_trace()
    # TODO: Cannot understand why plus 1 happens
...
def points2img(points, image_height, image_width, size_x=4, size_y=4):
    """
    :param points: [B, num_points, 3]
    :param image_width:
    :param image_height:
    ...
    return coordinates, extended_x.view(batch, -1), extended_y.view(batch, -1), depth
...
class PCViews:
    ...
    def get_img_coord(self, points, resolution=128):
        ...
        coordinates, x, y, depth = points2img(
            points=_points,
        ...
        return coordinates, x, y, depth

    def get_img(self, points, resolution):
        """Get image based on the prespecified specifications.
